...
cmd = f'write_int_array,Control1.CONTROL_REQUEST[0], 0, 24, 268435460, 3000, 240, 0, 30, 0\n'
s.send(cmd.encode())
data = s.recv(BUFFER_SIZE)
print(data)
...
cmd = f'write_int_array,Control1.CONTROL_REQUEST[0], 0, 24, 268435460, 3000, 0, 0, 30, 0\n'
s.send(cmd.encode())
data = s.recv(BUFFER_SIZE)
print(data)
...
s.send(b'set_value,Control1.coeff[0], 0.1\n')
data = s.recv(BUFFER_SIZE)
print (data)
