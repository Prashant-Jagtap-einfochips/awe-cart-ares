 ...
 */
BAF_Resource* CART_resource(BAF* baf)
{
 ...
 */
uint32_t CART_exec(BAF* baf, uint32_t thread_level, void* arg)
{
 ...
 */
uint32_t CART_command(BAF* baf, BAF_Message* req, BAF_Message* rsp)
{
 ...
 */
void CART_register_notify(BAF* baf, BAF_Func_Notify notify)
{
 ...
 */
uint32_t CART_schedule(BAF* baf, void* arg)
{
 ...
 */
const char* CART_version(BAF* baf)
{
