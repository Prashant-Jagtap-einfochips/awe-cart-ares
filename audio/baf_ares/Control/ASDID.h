 ...
 * File: ASDID.h
 *
 * Code generated for Simulink model 'Model_1_1'.
 *
 * Model version                  : 1.138
 * Simulink Coder version         : 9.8 (R2022b) 13-May-2022
 * C/C++ source code generated on : Sat Apr 13 16:44:51 2024
 *
 ...
 *             see ASDID_TYPE
 *             0 = Indicates the ID is for a TOP
 *             1 = Indicates the ID is an RTC
 *             2 = Indicates the ID is TSP related
 *             3 = Reserved (unused)
 *
 ...
 *             0 is the value indicating a TOP token identifier
 *
 ...
 *
 *    type      : 2 bit value indicating the type of message, see ASDID_TYPE
 *              1 is the value indicating an RTC message
 *
 *    partition : 4 bit value, see ASDID_PARTITION
...
#define ASDID_IS_TOP(id)               (!ASDID_IS_SCH(id) && (0UL == ASDID_TYPE(id)))
#define ASDID_IS_RTC(id)               (!ASDID_IS_SCH(id) && (1UL == ASDID_TYPE(id)))
#define ASDID_IS_TSP(id)               (!ASDID_IS_SCH(id) && (2UL == ASDID_TYPE(id)))
