...
__xt_mpu_init_table[] __attribute__((section(".ResetHandler.text"))) = {
  ...
  XTHAL_MPU_ENTRY(0x70000000, 1, XTHAL_AR_RWXrwx, XTHAL_MEM_WRITEBACK), // iocached
  XTHAL_MPU_ENTRY(0x7da00000, 1, XTHAL_AR_NONE, XTHAL_MEM_DEVICE), // unused
  XTHAL_MPU_ENTRY(0x80000000, 1, XTHAL_AR_RWXrwx, XTHAL_MEM_DEVICE), // rambypass
  XTHAL_MPU_ENTRY(0x90000000, 1, XTHAL_AR_RWXrwx, XTHAL_MEM_DEVICE), // iobypass
  XTHAL_MPU_ENTRY(0x9da00000, 1, XTHAL_AR_NONE, XTHAL_MEM_DEVICE), // unused
};
...
#endif
const unsigned int
__xt_mpu_init_table_size __attribute__((section(".ResetHandler.text"))) = 13;

#if defined (__cplusplus)
extern "C"
#endif
const unsigned int
__xt_mpu_init_cacheadrdis __attribute__((section(".ResetHandler.text"))) = 245;


#if defined (__STDC_VERSION__) && (__STDC_VERSION__ >= 201112L)
#include <assert.h>
static_assert(sizeof(__xt_mpu_init_table)/sizeof(__xt_mpu_init_table[0]) == 13, "Incorrect MPU table size");
