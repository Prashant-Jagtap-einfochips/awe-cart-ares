...
// This test file should mimic single thread of apx_wrapper. And multithreading 
// would be part of baas.c to be part of shared library.
#ifdef PLATFORM_MULTIRATE_AUDIOTHREADS
#undef PLATFORM_MULTIRATE_AUDIOTHREADS
#endif 

#define QNA_PIL_SHARED_LIBRARY
