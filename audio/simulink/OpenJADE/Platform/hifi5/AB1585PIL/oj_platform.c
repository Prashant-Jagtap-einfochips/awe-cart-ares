...
__attribute__((section(".oj_ext_data"))) uint8_t g_control_hex[CONTROL_LINE_SIZE];
__attribute__((section(".oj_ext_data"))) uint32_t g_request_buff[CONTROL_LINE_SIZE/8];
__attribute__((section(".oj_ext_data"))) uint32_t g_response_buff[CONTROL_LINE_SIZE/8];
...
extern void oj_platform_init(void);
