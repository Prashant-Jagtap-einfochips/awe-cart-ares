...
MEMORY
{
  sram0_seg :                         	org = 0x042CC000, len = 0x34000
  dram0_0_seg :                       	org = 0x04580000, len = 0x80000
  dram0_1_seg :                       	org = 0x04600000, len = 0x100000
...
_memmap_mem_sram_start = 0x42cc000;
_memmap_mem_sram_end   = 0x4300000;
_memmap_mem_dram0_start = 0x4580000;
_memmap_mem_dram0_end   = 0x4700000;
...
_memmap_seg_sram0_start = 0x42cc000;
_memmap_seg_sram0_max   = 0x4300000;
_memmap_seg_dram0_0_start = 0x4580000;
_memmap_seg_dram0_0_max   = 0x4600000;
_memmap_seg_dram0_1_start = 0x4600000;
_memmap_seg_dram0_1_max   = 0x4700000;
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0x4300000);
  _heap_sentry = 0x4300000;
