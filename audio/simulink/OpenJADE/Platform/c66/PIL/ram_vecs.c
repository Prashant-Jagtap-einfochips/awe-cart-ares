...
#pragma DATA_SECTION(data_request_hex, ".oj_ext_data")
unsigned char data_request_hex[] = {
   #include "request_ojx.h"
};

#pragma DATA_SECTION(data_in_binary, ".oj_ext_data")
unsigned char data_in_binary[] = {
   #include "audioIn_bin.h"
};

#pragma DATA_SECTION(data_gold_binary, ".oj_ext_data")
unsigned char data_gold_binary[] = {
   #include "audioRef_bin.h"
};

#pragma DATA_SECTION(data_out_binary, ".oj_ext_data")
unsigned char data_out_binary[] = {
   #include "audioRef_bin.h"
};

#pragma DATA_SECTION(data_response_hex, ".oj_ext_data")
unsigned char data_response_hex[128*1024];
