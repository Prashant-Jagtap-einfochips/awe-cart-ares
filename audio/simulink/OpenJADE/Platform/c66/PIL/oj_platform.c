...
#pragma DATA_SECTION(g_control_hex, ".oj_ext_data")
uint8_t g_control_hex[CONTROL_LINE_SIZE];

#pragma DATA_SECTION(g_request_buff, ".oj_ext_data")
uint32_t g_request_buff[CONTROL_LINE_SIZE/8];

#pragma DATA_SECTION(g_response_buff, ".oj_ext_data")
...
extern void c6678_platform_init(void);
