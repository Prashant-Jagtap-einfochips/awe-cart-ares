function cs = ConfigSetSharcPlusGXP()
% MATLAB function for configuration set generated on 18-Aug-2023 08:27:02
...
cs.set_param('MaxStackSize', '2048');   % Maximum stack size (bytes)
...
cs.set_param('UnknownTsInhSupMsg', 'none');   % Unspecified inheritability of sample time
...
cs.set_param('ProdLargestAtomicInteger', 'Long');   % Largest atomic integer size
...
cs.set_param('Toolchain', 'ADSP-SC58x v2.3 | gmake makefile (64-bit Windows)');   % Toolchain
cs.set_param('BuildConfiguration', 'Release - ADSP-SC584');   % Build configuration
...
cs.set_param('MaxIdLength', 61);   % Maximum identifier length
...
cs.set_param('CodeReplacementLibrary', 'SHARC+ Griffin Lite XP (GLXP) code replacement library');   % Code replacement library
...
cs.set_param('EnableUserReplacementTypes', 'off');   % Replace data type names in generated code
