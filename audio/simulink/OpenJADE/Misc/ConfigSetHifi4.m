function cs = ConfigSetHifi4()
% MATLAB function for configuration set generated on 18-Aug-2023 08:26:03
...
cs.set_param('Name', 'ConfigSetHifi4'); % Name
...
cs.set_param('MaxStackSize', '16384');   % Maximum stack size (bytes)
...
cs.set_param('Toolchain', 'Xtensa Toolchain RI-2020.5-win32 (64-bit Windows)');   % Toolchain
...
cs.set_param('CodeReplacementLibrary', 'HiFi4 code replacement library');   % Code replacement library
