function cs = ConfigSetHexagon()
% MATLAB function for configuration set generated on 31-May-2023 14:35:18
...
cs.set_param('Name', 'ConfigSetHexagon'); % Name
...
cs.set_param('StopTime', '1');   % Stop time
...
cs.set_param('MultiTaskRateTransMsg', 'warning');   % Multitask data transfer
...
cs.set_param('CustomCodeUndefinedFunction', 'UseInterfaceOnly');   % Undefined function and variable handling
...
cs.set_param('CodeReplacementLibrary', 'Qualcomm Hexagon DSP code replacement library');   % Code replacement library
