...
/* switch 0 register settings */
static SWITCH_CONFIG EV_21593_SOM_SwitchConfig0[] =
{
...
/* switch configuration */
static SOFT_SWITCH EV_21593_SOM_SoftSwitch[] =
{
  2u,
  0x21u,
  sizeof(EV_21593_SOM_SwitchConfig0)/sizeof(SWITCH_CONFIG),
  EV_21593_SOM_SwitchConfig0
};
...
void ConfigSoftSwitches_EV_SOM(void)
{
   ConfigSoftSwitches(EV_21593_SOM_SoftSwitch, (uint32_t)(sizeof(EV_21593_SOM_SoftSwitch)/sizeof(SOFT_SWITCH)));
}
