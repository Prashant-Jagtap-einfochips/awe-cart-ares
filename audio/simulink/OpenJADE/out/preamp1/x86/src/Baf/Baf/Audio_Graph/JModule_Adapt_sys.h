...
void _BAF_Callback_sys_process_ctx(void* framework, uint32_t proc_Id, uint32_t frame_size, uint32_t num_chan_in, uint32_t num_chan_out, void* src, void* dst, void* ctx);
...
static void JModule_Adapt_Sys_cr1_in_port_process(JModule* this, Process* process, Process_Context* process_ctx, uint32_t thread_level, void* arg)
{
    ...
    _BAF_Callback_sys_process_ctx(this->framework, PROCESS_SYS_CR1_IN__OUT1/*proc_id*/, port_out->port[0].frame_size,
         0 /* num_chan_in*/, port_out->port[0].num_chan, NULL, dst, arg);
}
...
static void JModule_Adapt_Sys_cr1_out_port_process(JModule* this, Process* process, Process_Context* process_ctx, uint32_t thread_level, void* arg)
{
    ...
    _BAF_Callback_sys_process_ctx(this->framework, PROCESS_SYS_CR1_OUT__IN1/*proc_id*/, port_in->port[0].frame_size,
        port_in->port[0].num_chan, 0 /* num_chan_out*/, src, NULL, arg);
}
