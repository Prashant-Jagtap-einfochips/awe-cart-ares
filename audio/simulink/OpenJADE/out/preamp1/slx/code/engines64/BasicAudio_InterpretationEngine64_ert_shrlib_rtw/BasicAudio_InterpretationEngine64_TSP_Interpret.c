/*
 * File: BasicAudio_InterpretationEngine64_TSP_Interpret.c
 *
...
#include "BasicAudio_InterpretationEngine64.h" // for TSP output signals
...
{
    {                                  /* '<S2>/TSP' */
        "DUMMY_EMPTY", 0, TSS_SINGLE, sizeof(real32_T), 1U,
        &BasicAudio_InterpretationEngine64_B.TSP
    },
};

// Share table in a public interface for use by top-model
void* BasicAudio_InterpretationEngine64_tsp_interpret_table =
    tsp_interpret_table;
int BasicAudio_InterpretationEngine64_tsp_interpret_table_count = sizeof
