% Autogenerated file: Wed Jul 17 15:49:19 2024
...
wr = coder.internal.writeDataInterfacesToCodeDescriptor("BasicAudio_InterpretationEngine64",pwd) ;
...
skippedParameters = [];
    ...
    func_Initialize_Prototype.Return     = tmpRet;
        ...
        func_Initialize_Prototype.HeaderFile = 'BasicAudio_InterpretationEngine64.h';
    func_Initialize_Prototype.SourceFile = 'BasicAudio_InterpretationEngine64.c';
    ...
    func_Initialize_Interface.ActualReturn = tmpActualReturn;
        ...
        func_Initialize_Prototype.Name = 'BasicAudio_InterpretationEngine64_initialize';
    ...
    func_OutputUpdate_Prototype.Return     = tmpRet;
        ...
        func_OutputUpdate_Prototype.HeaderFile = 'BasicAudio_InterpretationEngine64.h';
    func_OutputUpdate_Prototype.SourceFile = 'BasicAudio_InterpretationEngine64.c';
    ...
    func_OutputUpdate_Interface.ActualReturn = tmpActualReturn;
            ...
            func_OutputUpdate_Prototype.Name = 'BasicAudio_InterpretationEngine64_step';
    ...
    func_Terminate_Prototype.Return     = tmpRet;
        ...
        func_Terminate_Prototype.HeaderFile = 'BasicAudio_InterpretationEngine64.h';
    func_Terminate_Prototype.SourceFile = 'BasicAudio_InterpretationEngine64.c';
    ...
    time_constant = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, -1));
        func_Terminate_Interface.Timing = time_constant;
                func_Terminate_Prototype.Name = ['BasicAudio_InterpretationEngine64_terminate'];
        codeInfo.TerminateFunctions =  [codeInfo.TerminateFunctions, func_Terminate_Interface'];
            ...
            type_RTModel.Identifier = 'RT_MODEL_BasicAudio_InterpretationEngine64_T';
        ...
        Var_RTModel = RTW.Variable(Ptrtype_RTModel_1_0.BaseType, 'BasicAudio_InterpretationEngine64_M_');
        Var_RTModel.Owner           = 'BasicAudio_InterpretationEngine64';
        Var_RTModel.DeclarationFile = 'BasicAudio_InterpretationEngine64.h';
            Var_RTModel.DefinitionFile  = 'BasicAudio_InterpretationEngine64.c';
        

        % Pointer Variable: PtrVar_RTModel
        PtrVar_RTModel = RTW.PointerVariable(Ptrtype_RTModel_1_0, 'BasicAudio_InterpretationEngine64_M', Var_RTModel);
