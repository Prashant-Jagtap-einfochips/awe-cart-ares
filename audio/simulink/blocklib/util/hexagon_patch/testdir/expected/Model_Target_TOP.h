...
typedef struct Model_Target_Near0_tag
{
    ...
    __attribute__ ((__aligned__(8))) real32_T Fr_PoolIirTunablepooliirCoeffs[404];/* '<S99>/TOP1' */
    __attribute__ ((__aligned__(8))) real32_T Fr_PooliirpooliirCoeffs[405];/* '<S87>/TOP1' */
...
typedef struct Model_Target_PostProcess0_tag
{
    ...
    __attribute__ ((__aligned__(8))) real32_T PostLimiterEqpooliirCoeffs[536];/* '<S626>/TOP1' */
...
typedef struct Model_Target_PreAmp0_tag
{
    ...
    __attribute__ ((__aligned__(8))) real32_T MedusaBassManagerHpfpooliirCoeffs[26];/* '<S1175>/TOP1' */
    __attribute__ ((__aligned__(8))) real32_T MedusaBassManagerLpfpooliirCoeffs[26];/* '<S1183>/TOP1' */
    real32_T MedusaDRHoligramOutputMapping[18];/* '<S1732>/TOP' */
    __attribute__ ((__aligned__(8))) real32_T MedusaDRHoligramPoolIirTunableConfigpooliirCoeffs[5346];/* '<S1723>/TOP1' */
    ...
    __attribute__ ((__aligned__(8))) real32_T MedusaFRHoligramIirConfigpooliirCoeffs[726];/* '<S1734>/TOP1' */
    ...
    __attribute__ ((__aligned__(8))) real32_T MedusaHeadrestCompEQIirConfigpooliirCoeffs[972];/* '<S1756>/TOP1' */
    __attribute__ ((__aligned__(8))) real32_T MedusaMonoDetectorHPFCoeffs[10];/* '<S1399>/TOP11' */
    ...
    __attribute__ ((__aligned__(8))) real32_T MedusaSPUMDecayEstHPFpooliirCoeffs[50];/* '<S1420>/TOP1' */
