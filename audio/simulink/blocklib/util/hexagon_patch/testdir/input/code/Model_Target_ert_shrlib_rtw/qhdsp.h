...
/** @defgroup qhdsp_library QHDSP library
 *  @{
 */
 ...
 *                                  3. twiddles1 & twiddles2 - generated with qhdsp_fft_gen_twiddles_real_acf() function
 *                                  4. output buffer - aligned by 8 bytes
 *                  - Constraints:
 *                                  1. nr_points has to be >= 8 (and power of 2)
 */
void qhdsp_acf_r1dfft_af(const float *input, int32_t nr_points, const float complex *twiddles1, const float complex *twiddles2, float complex *output);
 ...
 *                                  3. Wt1 & Wt2 - generated with qhdsp_fft_gen_twiddles_real_acf() function
 *                                  4. output buffer - aligned by 8 bytes
 *                  - Constraints:
 *                                  1. nr_points has to be >= 8 (and power of 2)
 */
void qhdsp_af_r1difft_acf(const float complex* input, int32_t nr_points, const float complex* Wt1, const float complex* Wt2, float complex* output);
 ...
 *                                  3. w - generated with qhdsp_fft_gen_twiddles_complex_acf() function
 *                                  4. output buffer - aligned by 8 bytes
 *                  - Constraints:
 *                                  1. nr_points has to be >= 4 (and power of 2)
 */
void qhdsp_c1dfft_acf(const float complex *input, int32_t N, const float complex *w, float complex *output);
 ...
 *                                  1. nr_points has to be >= 4 (and power of 2)
 */
void qhdsp_c1difft_acf(const float complex* input, int32_t N, const float complex* w, float complex* output);
 ...
 *                                  3. Wt1 & Wt2 - generated with qhdsp_fft_gen_twiddles_complex_ach() function
 *                                  4. output buffer - aligned by 8 bytes
 *                  - Constraints:
 *                                  1. N has to be >= 16 (and power of 2)
 */
void qhdsp_ach_r1dfft_ah(const int16_t* input, int32_t N, const int32_t* Wt1, const int32_t* Wt2, int32_t* output);
 ...
 *                                  1. N has to be >= 16 (and power of 2)
 */
void qhdsp_ah_r1difft_ach(const int32_t *input, int32_t N, const int32_t *Wt1, const int32_t *Wt2, int16_t *output);
 ...
 *                                  3. w - generated with qhdsp_fft_gen_twiddles_complex_ach() function
 *                                  4. output buffer - aligned by 8 bytes
 *                  - Constraints:
 *                                  1. nr_points has to be >= 8 (and power of 2)
 */
void qhdsp_c1dfft_ach(const int32_t *input, int32_t N, const int32_t *w, int32_t *output);
 ...
 *                                  1. nr_points has to be >= 8 (and power of 2)
 */
void qhdsp_c1difft_ach(const int32_t *input, int32_t N, const int32_t *w, int32_t *output);
 ...
 */
int32_t qhdsp_fir_ah(int16_t *in_samples, int16_t *coefs, uint32_t taps, uint32_t length, int16_t *out_samples);
 ...
 */
int32_t qhdsp_fir_af(const float *in_samples, float *delay_line, const float *coefs, uint32_t taps, uint32_t length, float_a8_t *out_samples);
 ...
 * @param[in]       length      length of input/output data (number of samples)
 * @param[out]      out_samples output buffer
 * @note            States buffer should be aligned to 8 bytes
 */
int32_t qhdsp_iir_af(const float *in_samples, const float *coefs, float *states, uint32_t num_biquads, uint32_t length, float *out_samples);
 ...
 *
 */
int32_t qhdsp_iir_ah(const int16_t *in_samples, const int16_t *coefs, int64_t *states, uint32_t num_biquads, uint32_t length, int16_t *out_samples);
 ...
 */
int32_t qhdsp_firdecim_af(const float *in_samples, float *delay_line, const float *coefs, uint32_t taps,
 ...
 *                                  4. new incoming samples stored at [taps-1] offset in in_samples buffer
 */
int32_t qhdsp_firdecim_ah(int16_t *in_samples, int16_t *coefs, uint32_t taps,
 ...
 * @note            States buffer should be aligned to 8 bytes
 */
int32_t qhdsp_iirdecim_af(float *in_samples, float *coefs, float *states, uint32_t num_biquads,
                       uint32_t length, uint32_t decimator, float *out_samples);
 ...
 *
 */
int32_t qhdsp_iirdecim_ah(int16_t *in_samples, int16_t *coefs, int64_t *states, uint32_t num_biquads,
                       uint32_t length, uint32_t decimator, int16_t *out_samples);
 ...
 * @note            States buffer should be aligned to 8 bytes
 */
int32_t qhdsp_iirinterp_af(float *in_samples, float *coefs, float *states, uint32_t num_biquads,
 ...
 */
int32_t qhdsp_iirinterp_ah(int16_t *in_samples, int16_t *coefs, int64_t *states, uint32_t num_biquads,
