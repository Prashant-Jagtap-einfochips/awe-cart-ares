...
typedef struct
{
    ...
    real32_T LR_m[64];                 /* '<S1170>/Selector1' */
    real32_T Mean[32];                 /* '<S1164>/Mean' */
    real32_T Sum[64];                  /* '<S1172>/Sum' */
    ...
    real32_T audioOut_m[128];          /* '<S95>/MATLAB Function' */
    real32_T audioOut_dj[160];         /* '<S83>/MATLAB Function' */
    real32_T audioOut_o[32];           /* '<S51>/MATLAB Function' */
    real32_T audioOut_o2[56];          /* '<S39>/MATLAB Function' */
