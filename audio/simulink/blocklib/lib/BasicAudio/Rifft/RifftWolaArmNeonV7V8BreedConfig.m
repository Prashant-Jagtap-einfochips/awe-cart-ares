classdef RifftWolaArmNeonV7V8BreedConfig < BtcBreedBaseClass
% RifftWolaArmNeonV7V8BreedConfig Build-time configuration class for the RifftWolaArmNeonV7V8 breed
% Usage:
...
%   Copyright 2023 Bose Corporation
  ...
  methods
    %----------------------------------------------------------------------
    function this = RifftWolaArmNeonV7V8BreedConfig(constructingParentObj)
