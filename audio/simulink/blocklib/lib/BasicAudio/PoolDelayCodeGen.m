function audioOut = PoolDelayCodeGen(audioIn, delayTime, totalDelayBufferSize)

    % Delay line lives in global variable and it is treated as a circular buffer
    global fastDelayBuffer;
