...
Function Name : _IFirProcess.

C Callable : Yes, leaf function

C ProtoType :void IFirProcess(float *, const float *, unsigned int, unsigned int, 
         float *, int, int* ,const float *,const unsigned int*, int);
...
_IFirProcess:
   ...
   bit set Mode1 BDCST1;  //Set i1 for broadcast loads. We use i1 to access
                                          //coefficients array. 
   ...
   */
   ...
   lcntr=m4, do Channel_Loop until lce;  //Loop over all channels, (channel=0-->numChannels-1)
      ...
      modify(i14,m9);                    //i14-->current starting point for writing 
      ...
      modify(i1,m1);                     //i1 points to last coefficient in coeffs array                     
