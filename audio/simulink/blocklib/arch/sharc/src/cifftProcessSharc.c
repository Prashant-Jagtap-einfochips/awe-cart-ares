...
*PROTOTYPE: cifft_process(complex_float* output,       - Output buffer
...
// Function definition for IFFT CRL wrapper
void cifft_process(creal32_T output[], creal32_T input[], creal32_T temp[], unsigned int fftSize, unsigned int numChannels, int twiddleStride)
{
   int i;
