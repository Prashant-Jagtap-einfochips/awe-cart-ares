 ...
 */
void qhdsp_fft_gen_twiddles_complex_acf(float complex* twiddle, int32_t NP, int32_t log2NP);
 ...
 */
void qhdsp_fft_gen_twiddles_real_acf(float complex *twiddle1, float complex *twiddle2, int32_t np, int32_t log2np);
 ...
 */
void qhdsp_fft_gen_twiddles_complex_ach(int32_t* twiddle, int32_t NP, int32_t log2NP);
 ...
 */
void qhdsp_fft_gen_twiddles_real_ach(int32_t* twiddle1, int32_t* twiddle2, int32_t NP, int32_t log2NP);
