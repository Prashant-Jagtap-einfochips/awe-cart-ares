...
typedef struct Pooliir_s
{
    ...
    qurt_thread_t threads[MAX_THREAD_NUM_IIR];
    qurt_thread_attr_t attr[MAX_THREAD_NUM_IIR];
    Pooliir_thread_args thread_arg[MAX_THREAD_NUM_IIR];
    void* thread_stack_addr[MAX_THREAD_NUM_IIR];
#endif
