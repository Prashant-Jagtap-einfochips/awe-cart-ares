function hLib = SharcPlusGLXPCRLTable
...
%---------- entry: iir_accelerator_hw_init ----------- 
hEnt = createCRLEntry(hLib, ...
    'uint32 y1 = iir_accelerator_hw_init( uint32 u1, uint32 u2 )', ...
    'void unused = iir_accelerator_hw_init( uint32* y1, uint32 u1, uint32 u2 )');
hEnt.setTflCFunctionEntryParameters( ...
          'Priority', 100, ...
...
hEnt = createCRLEntry(hLib, ...
'single y1 = pooliirAccelInit( single u1[1 1; 1024 1024], uint32 u2, uint32 u3, uint32 u4[1 1; 128 128], single u5[1 1; 8192 8192], uint32 u6, single u7[1 1; 32768 32768], uint32 u8 )', ...
'void unused = iir_accelerator_init( single* y1, const single* u1, uint32 u2, uint32 u3, const uint32* u4, const single* u5, uint32 u6, single* u7, uint32 u8 )');
hEnt.setTflCFunctionEntryParameters( ...
          'Priority', 100, ...
          'ImplementationHeaderFile', 'pooliirAccelerator.h', ...
          'ImplementationSourceFile', 'pooliirAccelerator.c', ...
...
hEnt = createCRLEntry(hLib, ...
'single y1 = pooliirAccelInit( single u1[1 1; 1024 1024], uint32 u2, uint32 u3, uint32 u4, single u5[1 1; 8192 8192], uint32 u6, single u7[1 1; 32768 32768], uint32 u8 )', ...
'void unused = iir_accelerator_init( single* y1, const single* u1, uint32 u2, uint32 u3, const uint32* u4, const single* u5, uint32 u6, single* u7, uint32 u8 )');
hEnt.setTflCFunctionEntryParameters( ...
          'Priority', 100, ...
          'ImplementationHeaderFile', 'pooliirAccelerator.h', ...
...
hEnt = createCRLEntry(hLib, ...
    'uint32 y1 = fir_core_init( single u1[1 1; 1024 1024], single u2[1 1; 32768 32768], single u3[1 1; 131072 131072], uint32 u4[1 1; 1024 1024], uint32 u5[1 1; 1024 1024], uint32 u6[1 1; 1024 1024], uint32 u7, uint32 u8, uint32 u9, uint32 u10, uint32 u11[1 1; 65536 65536] )', ...
...
hEnt = createCRLEntry(hLib, ...
    'uint32 y1 = fir_core_init( single u1[1 1; 1024 1024], single u2[1 1; 32768 32768], single u3[1 1; 131072 131072], uint32 u4, uint32 u5[1 1; 1024 1024], uint32 u6[1 1; 1024 1024], uint32 u7, uint32 u8, uint32 u9, uint32 u10, uint32 u11[1 1; 65536 65536] )', ...
    'void unused = fir_core_init( uint32* y1, const single* u1, const single* u2, single* u3, const uint32* u4, const uint32* u5, const uint32* u6, uint32 u7, uint32 u8, uint32 u9, uint32 u10, uint32* u11 )');
hEnt.setTflCFunctionEntryParameters( ...
          'Priority', 100, ...
          'ImplementationHeaderFile', 'fir_core.h', ...
...
% single output/coeff
hEnt = createCRLEntry(hLib, ...
    'uint32 y1 = fir_core_init( single u1[1 1; 1024 1024], single u2[1 1; 32768 32768], single u3[1 1; 131072 131072], uint32 u4, uint32 u5, uint32 u6, uint32 u7, uint32 u8, uint32 u9, uint32 u10, uint32 u11[1 1; 65536 65536] )', ...
    'void unused = fir_core_init( uint32* y1, const single* u1, const single* u2, single* u3, const uint32* u4, const uint32* u5, const uint32* u6, uint32 u7, uint32 u8, uint32 u9, uint32 u10, uint32* u11 )');
hEnt.setTflCFunctionEntryParameters( ...
          'Priority', 100, ...
          'ImplementationHeaderFile', 'fir_core.h', ...
...
%---------- entry: fir_accelerator_hw_init ----------- 
hEnt = createCRLEntry(hLib, ...
    'uint32 y1 = fir_accelerator_hw_init( uint32 u1, uint32 u2 )', ...
    'void unused = fir_accelerator_hw_init( uint32* y1, uint32 u1, uint32 u2 )');
hEnt.setTflCFunctionEntryParameters( ...
          'Priority', 100, ...
...
hEnt = createCRLEntry(hLib, ...
    'uint32 y1 = fir_accelerator_init( single u1[1 1; 1024 1024], single u2[1 1; 32768 32768], single u3[1 1; 131072 131072], uint32 u4, uint32 u5[1 1; 1024 1024], uint32 u6[1 1; 1024 1024], uint32 u7[1 1; 1024 1024], uint32 u8, uint32 u9, uint32 u10, uint32 u11, uint32 u12, uint32 u13[1 1; 65536 65536], uint32 u14 )', ...
    'void unused = fir_accelerator_init( uint32* y1, const single* u1, const single* u2, single* u3, uint32 u4, const uint32* u5, const uint32* u6, const uint32* u7, uint32 u8, uint32 u9, uint32 u10, uint32 u11, uint32 u12, uint32* u13, uint32 u14 )');
hEnt.setTflCFunctionEntryParameters( ...
          'Priority', 100, ...
          'ImplementationHeaderFile', 'fir_accelerator.h', ...
          'ImplementationSourceFile', 'fir_accelerator.c', ...
...
hEnt = createCRLEntry(hLib, ...
    'uint32 y1 = fir_accelerator_init( single u1[1 1; 1024 1024], single u2[1 1; 32768 32768], single u3[1 1; 131072 131072], uint32 u4, uint32 u5, uint32 u6[1 1; 1024 1024], uint32 u7[1 1; 1024 1024], uint32 u8, uint32 u9, uint32 u10, uint32 u11, uint32 u12, uint32 u13[1 1; 65536 65536], uint32 u14 )', ...
    'void unused = fir_accelerator_init( uint32* y1, const single* u1, const single* u2, single* u3, uint32 u4, const uint32* u5, const uint32* u6, const uint32* u7, uint32 u8, uint32 u9, uint32 u10, uint32 u11, uint32 u12, uint32* u13, uint32 u14 )');
hEnt.setTflCFunctionEntryParameters( ...
          'Priority', 100, ...
          'ImplementationHeaderFile', 'fir_accelerator.h', ...
...
hEnt = createCRLEntry(hLib, ...
    'uint32 y1 = fir_accelerator_init( single u1[1 1; 1024 1024], single u2[1 1; 32768 32768], single u3[1 1; 131072 131072], uint32 u4, uint32 u5, uint32 u6, uint32 u7, uint32 u8, uint32 u9, uint32 u10, uint32 u11, uint32 u12, uint32 u13[1 1; 65536 65536], uint32 u14 )', ...
    'void unused = fir_accelerator_init( uint32* y1, const single* u1, const single* u2, single* u3, uint32 u4, const uint32* u5, const uint32* u6, const uint32* u7, uint32 u8, uint32 u9, uint32 u10, uint32 u11, uint32 u12, uint32* u13, uint32 u14 )');
hEnt.setTflCFunctionEntryParameters( ...
          'Priority', 100, ...
          'ImplementationHeaderFile', 'fir_accelerator.h', ...
