...
*
* WARNING:       process and reset function prototypes has been updated so that
*                a library using this module can be built using CCES/SC584
*                toolchain but the functions has not been updated and tested.
*                This has to be done before we use this module for audio
*                processing. See FirEven.asm in BDSP for reference. [2/28/2018]
********************************************************************************/
