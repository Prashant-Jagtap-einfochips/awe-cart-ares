...
#elif defined(__ADSPSC569_FAMILY__)
    #include "GulTranslateAddr.h"
#endif /* __ADSPSC594_FAMILY__ */


/***  Debug Support  **********************************************************/

// Shared Delay debugging support. Define DEBUG_SHARED_DELAY on the build 
// command line to enable Shared Delay debugging. Note that for profiling
// and production use, DEBUG_SHARED_DELAY should not be defined, ADI_DEBUG
// should NOT be defined for the EMDMA drivers, and compiler optimization
// flags should be SET as stated above. 

#if defined(DEBUG_SHARED_DELAY)
...
#if defined(__ADSPSC594_FAMILY__)
    #define SHARED_DELAY_EMDMA_STREAM  gEmdmaGetCoreStreamAssignment()
#elif defined(__ADSPSC569_FAMILY__)
    #define SHARED_DELAY_EMDMA_STREAM  GEMDMA_STREAM_1
#endif /* __ADSPSC594_FAMILY__ */
                          ...
                          const int *delayChain )
{
    ...
    eResult = gEmdmaCreateFastCopy(SHARED_DELAY_EMDMA_STREAM,
