...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% - Generated on:   02-Apr-2024 10:54:19
...
switch action
  ...
  case 'CSCDefn'
    ...
    set(h, 'DeclareComment', '');
    set(h, 'DefineComment', '');
    set(h, 'CSCTypeAttributesClassName', 'Bose.CSCAttrib_BoseFlatStructure');
        set(h.CSCTypeAttributes, 'PreprocessorDefine', true);
        set(h.CSCTypeAttributes, 'CreateIDsForTOPs', true);
        set(h.CSCTypeAttributes, 'CodeInitialValue', '');
        set(h.CSCTypeAttributes, 'PreOverlay', '');
        set(h.CSCTypeAttributes, 'PostOverlay', '');
        set(h.CSCTypeAttributes, 'MemorySectionIfDef', '');
        set(h.CSCTypeAttributes, 'CompatibilityString', '');
        set(h.CSCTypeAttributes, 'StructName', '');
        set(h.CSCTypeAttributes, 'IsStructNameInstanceSpecific', true);
        ...
        set(h.CSCTypeAttributes, 'TypeToken', '');
        set(h.CSCTypeAttributes, 'TypeTag', '');
    set(h, 'TLCFileName', 'BoseFlatStructure.tlc');
    defs = [defs; h];
    ...
    set(h, 'DefineComment', '');
    set(h, 'CSCTypeAttributesClassName', 'Bose.CSCAttrib_BoseFlatStructure');
        set(h.CSCTypeAttributes, 'PreprocessorDefine', false);
        set(h.CSCTypeAttributes, 'CreateIDsForTOPs', false);
        set(h.CSCTypeAttributes, 'CodeInitialValue', '');
        set(h.CSCTypeAttributes, 'PreOverlay', '');
        set(h.CSCTypeAttributes, 'PostOverlay', '');
        set(h.CSCTypeAttributes, 'MemorySectionIfDef', '');
    ...
    set(h, 'DeclareComment', '');
    set(h, 'DefineComment', '');
    set(h, 'CSCTypeAttributesClassName', 'Bose.CSCAttrib_ApiBuffer');
        set(h.CSCTypeAttributes, 'SecretExport', false);
    set(h, 'TLCFileName', 'BoseUnstructured.tlc');
    defs = [defs; h];
