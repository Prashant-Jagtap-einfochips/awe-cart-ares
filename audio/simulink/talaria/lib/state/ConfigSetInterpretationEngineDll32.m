function cs = ConfigSetInterpretationEngineDll32()
%---------------------------------------------------------------------------
%  MATLAB function for configuration set generated on 30-Mar-2018 15:19:25
...
cs.set_param('Name', 'WindowsEngineDLL'); % Name
...
cs.set_param('Toolchain', 'MinGW64 | gmake (32-bit Windows)');   % Toolchain
...
cs.set_param('MaxIdLength', 128);   % Maximum identifier length
...
cs.set_param('ERTCustomFileTemplate', 'interpretation_dll.tlc');   % File customization template
