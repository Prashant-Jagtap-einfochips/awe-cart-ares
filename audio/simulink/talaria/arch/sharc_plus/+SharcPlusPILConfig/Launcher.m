...
%   Copyright 2007-2012 The MathWorks, Inc.
    ...
    methods
        ...
        function startApplication(this)
            ...
            platform = 'ADSP-SC584 Functional-Sim';
            core = 0;
            simArgs = sprintf('--processor %s --target "%s" --platform "%s" --core "%d,%s"', ...
                processor, target, platform, core, exe);
            % "C:\Analog Devices\CrossCore Embedded Studio 2.6.0\CCES_Runner.exe" --processor ADSP-SC584 --target "ChipFactory Simulator" --platform "ADSP-SC584 Functional-Sim" --core "0,rtiostream_project_Core1.dxe"
            ...
            disp(['Started new process, pid = ' ...                  
                  int2str(this.ExePid) ' stdout:' this.TempFile])                            
