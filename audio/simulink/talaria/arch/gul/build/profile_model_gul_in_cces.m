function [mips, num_kB] = profile_model_gul_in_cces(model_name, profile_run_count)
...
ldf_file = fullfile(getenv('GUL_LDF_DIR'), 'test.ldf');
...
platform = '"ADSP-21569 Cycle-Accurate-Sim"';
