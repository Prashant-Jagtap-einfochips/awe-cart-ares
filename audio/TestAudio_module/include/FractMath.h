...
// GCC compiler
#if defined(__GNUC__) && !defined(CORE_M55) && !defined(__ARMCC_VERSION) && !(__ARMCC_VERSION>6000000)
#include "cmsis_gcc.h"
#endif
...
#if (defined(__CC_ARM) && (__ARMCC_VERSION < 4100000)) || (defined(__GNUC__) && !defined(CORE_CORTEXM) && !defined(CORE_H7))
