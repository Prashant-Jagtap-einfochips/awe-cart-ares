function [MM, NAME] = make_TestAudio_module_pack(GENDOC)
%
% make_TestAudio_module_pack(GENDOC)
% Generates the TestAudio_module library.
...
%
% [MM, NAME]=make_TestAudio_module_pack(GENDOC)
...
NAME = 'TestAudio';
MM = cell(0,0);
MM{end+1} = TestAudio_module('temp');
if (nargout > 0)
 return;
end
...
awe_generate_doc(MM, DOC_DIR, fullfile(DOC_DIR, '_TestAudio_module.html'), 'TestAudio_module');
